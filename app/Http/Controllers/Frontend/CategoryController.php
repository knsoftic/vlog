...
class CategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $categories = Category::active()->topLevel()->withCount(['posts' => fn ($q) => $q->published()])->with('children')->orderBy('sort_order')->orderBy('name')->get();
    ...
    public function show(Request $request, string $slug)
    {
        ...
        $posts = Post::published()->where(fn ($q) => $q->whereIn('category_id', $ids)->orWhereIn('subcategory_id', $ids))
